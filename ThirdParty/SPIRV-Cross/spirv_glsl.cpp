...
void CompilerGLSL::emit_header()
{
	...
	// MODIFICATIONS BEGIN
	const auto emit_default_precision = [this](Options::Precision float_precision, Options::Precision int_precision)
	{
	...
	case ExecutionModelVertex:
		...
		if (options.es)
		{
			emit_default_precision(options.vertex.default_float_precision, options.vertex.default_int_precision);
		}
		// MODIFICATIONS END
		break;
	case ExecutionModelGeometry:
	...
	case ExecutionModelFragment:
		if (options.es)
		{
			...
			if (options.es)
			{
				emit_default_precision(options.fragment.default_float_precision, options.fragment.default_int_precision);
			}
			// MODIFICATIONS END
		}
