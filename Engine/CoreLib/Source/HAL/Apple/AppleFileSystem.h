...
/**
 * @brief Defines native implementations for an Apple file system.
 */
class FAppleFileSystem
{
public:
...
using FNativeDirectory = FAppleFileSystem;
using FNativeFile = FAppleFileSystem;
using FNativeFileSystem = FAppleFileSystem;
using FNativePath = FAppleFileSystem;