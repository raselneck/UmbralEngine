...
/**
 * @brief Defines native implementations for a Windows file system.
 */
class FWindowsFileSystem
{
public:
...
using FNativeDirectory = FWindowsFileSystem;
using FNativeFile = FWindowsFileSystem;
using FNativeFileSystem = FWindowsFileSystem;
using FNativePath = FWindowsFileSystem;